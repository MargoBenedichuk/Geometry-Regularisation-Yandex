...
Выводы странные, модель почему-то переобучилась, хотя никогда прежде такого не было. В других запусках модель с регуляризацией показывала стабильно немного лучшее акураси
(порядка 1% от всего датасета) по сравнению с моделью без регуляризации
